...
| Container quality | production build, migration ordering, health smoke test, API/PWA/worker/migrator/database SBOM generation, and high-or-critical Trivy findings across application and PostGIS images |
